...
class AgeEstimator():
    ...
    def plot_box_and_label(image, lw, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        wid=p2[0]-p1[0]
        ht=p2[1]-p1[1]
        crop1=image[p1[1]+(ht//3):p1[1]+(ht//2),p1[0]+wid-(wid//5):p2[0]-(wid//40)]
        crop2=image[p1[1]+((ht//5)+(ht//5)):p1[1]+(ht//2)+(ht//10),p1[0]+wid-(wid//3):p2[0]-(wid//10)]
        crop3=image[p1[1]+((ht//5)+(ht//5)):p1[1]+(ht//2)+(ht//10),p1[0]+(wid//3):p2[0]-(wid//2)]
        crop4=image[p1[1]+(ht//2):p1[1]+(ht//2)+(ht//5),p1[0]+wid-((wid//5)+(wid//5)):p2[0]-(wid//5)]
        crop5=image[p1[1]+((ht//2)+(ht//5)):p1[1]+(ht//2)+(ht//5)+(ht//5),p1[0]+wid-(wid//3):p2[0]-(wid//10)]
        #vert=np.concatenate((crop1,crop2,crop3,crop4,crop5),axis=0)
        ...
        cv2.rectangle(image, (p1[0]+wid-(wid//5),p1[1]+(ht//3)), (p2[0]-(wid//40),p1[1]+(ht//2)), color, thickness=lw, lineType=cv2.LINE_AA)
        cv2.rectangle(image, (p1[0]+wid-(wid//3),p1[1]+((ht//5)+(ht//5))), (p2[0]-(wid//10),p1[1]+(ht//2)+(ht//10)), color, thickness=lw, lineType=cv2.LINE_AA)
        cv2.rectangle(image, (p1[0]+(wid//3),p1[1]+((ht//5)+(ht//5))), (p2[0]-(wid//2),p1[1]+(ht//2)+(ht//10)), color, thickness=lw, lineType=cv2.LINE_AA)
        cv2.rectangle(image, (p1[0]+wid-((wid//5)+(wid//5)),p1[1]+(ht//2)), (p2[0]-(wid//5),p1[1]+(ht//2)+(ht//5)), color, thickness=lw, lineType=cv2.LINE_AA)
        cv2.rectangle(image, (p1[0]+wid-(wid//3),p1[1]+((ht//2)+(ht//5))), (p2[0]-(wid//10),p1[1]+(ht//2)+(ht//5)+(ht//5)), color, thickness=lw, lineType=cv2.LINE_AA)
        #cv2.rectangle(image, (p1[0]+wid-90,p1[1]+160), (p2[0]-10,p1[1]+280), color, thickness=lw, lineType=cv2.LINE_AA)
        #cv2.rectangle(image, (p1[0]+(wid//3),p1[1]+180), (p2[0]-(wid//3),p1[1]+280), color, thickness=lw, lineType=cv2.LINE_AA)
        #cv2.rectangle(image, (p1[0]+wid-170,p1[1]+220), (p2[0]-60,p1[1]+390), color, thickness=lw, lineType=cv2.LINE_AA)
        #cv2.rectangle(image, (p1[0]+wid-130,p1[1]+ht-180), (p2[0]-60,p1[1]+ht), color, thickness=lw, lineType=cv2.LINE_AA)
        #cv2.rectangle(image, (p1[0]+280,p1[1]+120), (p2[0]-5,p2[1]-220), color, thickness=lw, lineType=cv2.LINE_AA)
        #cv2.rectangle(image, (p1[0]+250,p1[1]+190), (p2[0]-15,p2[1]-180), color, thickness=lw, lineType=cv2.LINE_AA)
        #cv2.rectangle(image, (p1[0]+120,p1[1]+190), (p2[0]-120,p2[1]-180), color, thickness=lw, lineType=cv2.LINE_AA)
        #cv2.rectangle(image, (p1[0]+190,p1[1]+210), (p2[0]-90,p2[1]-140), color, thickness=lw, lineType=cv2.LINE_AA)
        #cv2.rectangle(image, (p1[0]+300,p1[1]+300), (p2[0]-110,p2[1]-50), color, thickness=lw, lineType=cv2.LINE_AA)
        if label:
